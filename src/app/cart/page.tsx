                    ...
                    {activeStep === 1 ? (
                        cartItems.map(item => (
                            ...
                            <div key={item.id} className="flex items-center justify-between">
                                ...
                                {/* DELETE BUTTON */}
                                <button className="w-8 h-8 rounded-full bg-red-100 hover:bg-red-200 transiton-all duration-300 text-red-400 flex items-center justify-center cursor-pointer">

    ...
    return (
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(handleShippingForm)}>
            ...
            <div className="flex flex-col gap-1">
                ...
                <input type="text" id="phone" placeholder="9119119" {...register("phone")} className="border-b border-gray-200 py-2 outline-none text-sm" />
                {errors.phone && (
            ...
            <div className="flex flex-col gap-1">
                ...
                <input type="text" id="address" placeholder="123 Main St, Fromtown" {...register("address")} className="border-b border-gray-200 py-2 outline-none text-sm" />
                {errors.address && (
            ...
            <div className="flex flex-col gap-1">
                ...
                <input type="text" id="city" placeholder="New York" {...register("city")} className="border-b border-gray-200 py-2 outline-none text-sm" />
                {errors.city && (
